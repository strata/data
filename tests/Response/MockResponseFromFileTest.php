...
final class MockResponseFromFileTest extends TestCase
{
    ...
    {
        $client = new MockHttpClient([new MockResponseFromFile(__DIR__ . '/responses/mock-response')]);
...
EOD;
    ...
    {
        $client = new MockHttpClient([new MockResponseFromFile(__DIR__ . '/responses/mock-response2')]);
        $response = $client->request('GET', 'http://localhost');
...
EOD;
    ...
    {
        $client = new MockHttpClient([new MockResponseFromFile(__DIR__ . '/responses/mock-response3')]);
        $response = $client->request('GET', 'http://localhost');
...
EOD;
    ...
    public function testNoFile()
    {
        ...
        $client = new MockHttpClient([new MockResponseFromFile(__DIR__ . '/responses/fake')]);
    }
